...
public record ClientProfileResponse(String email, String name, String phone, String company) {
    public static ClientProfileResponse from(Client client){
        ...
        return new ClientProfileResponse(client.getEmail(),client.getName(),phoneStr,companyStr);
    }
}
